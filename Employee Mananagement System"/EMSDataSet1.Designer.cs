...
namespace Employee_Mananagement_System {
    ...
    public partial class EMSDataSet1 : global::System.Data.DataSet {
        ...
        public partial class DepartmentDataTable : global::System.Data.TypedTableBase<DepartmentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DepartmentRow AddDepartmentRow(string DepName, int DepCode, string Location, int Telephone, string Status) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DepartmentRow FindByDepCode(int DepCode) {
        ...
        public partial class DepartmentRow : global::System.Data.DataRow {
            ...
            public int DepCode {
                get {
                    return ((int)(this[this.tableDepartment.DepCodeColumn]));
                }
                set {
                    this[this.tableDepartment.DepCodeColumn] = value;
                }
            }
            ...
            public int Telephone {
                get {
                    return ((int)(this[this.tableDepartment.TelephoneColumn]));
                }
                set {
...
namespace Employee_Mananagement_System.EMSDataSet1TableAdapters {
    ...
    public partial class DepartmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Department] WHERE (([DepName] = @Original_DepName) AND ([DepCo" +
                "de] = @Original_DepCode) AND ([Location] = @Original_Location) AND ([Telephone] " +
                "= @Original_Telephone) AND ([Status] = @Original_Status))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Department] ([DepName], [DepCode], [Location], [Telephone], [S" +
                "tatus]) VALUES (@DepName, @DepCode, @Location, @Telephone, @Status);\r\nSELECT Dep" +
                "Name, DepCode, Location, Telephone, Status FROM Department WHERE (DepCode = @Dep" +
                "Code)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Department] SET [DepName] = @DepName, [DepCode] = @DepCode, [Location] = @Location, [Telephone] = @Telephone, [Status] = @Status WHERE (([DepName] = @Original_DepName) AND ([DepCode] = @Original_DepCode) AND ([Location] = @Original_Location) AND ([Telephone] = @Original_Telephone) AND ([Status] = @Original_Status));
SELECT DepName, DepCode, Location, Telephone, Status FROM Department WHERE (DepCode = @DepCode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Employee_Mananagement_System.Properties.Settings.Default.EMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DepName, DepCode, Location, Telephone, Status FROM dbo.Department";
        ...
        public virtual int Fill(EMSDataSet1.DepartmentDataTable dataTable) {
        ...
        public virtual EMSDataSet1.DepartmentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EMSDataSet1.DepartmentDataTable dataTable = new EMSDataSet1.DepartmentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EMSDataSet1.DepartmentDataTable dataTable) {
        ...
        public virtual int Delete(string Original_DepName, int Original_DepCode, string Original_Location, int Original_Telephone, string Original_Status) {
            ...
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_DepCode));
        ...
        public virtual int Insert(string DepName, int DepCode, string Location, int Telephone, string Status) {
            if ((DepName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(DepCode));
            if ((Location == null)) {
        ...
        public virtual int Update(string DepName, int DepCode, string Location, int Telephone, string Status, string Original_DepName, int Original_DepCode, string Original_Location, int Original_Telephone, string Original_Status) {
            if ((DepName == null)) {
                throw new global::System.ArgumentNullException("DepName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(DepCode));
            if ((Location == null)) {
                throw new global::System.ArgumentNullException("Location");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_DepCode));
            if ((Original_Location == null)) {
                throw new global::System.ArgumentNullException("Original_Location");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Telephone));
            if ((Original_Status == null)) {
                throw new global::System.ArgumentNullException("Original_Status");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string DepName, string Location, int Telephone, string Status, string Original_DepName, int Original_DepCode, string Original_Location, int Original_Telephone, string Original_Status) {
            return this.Update(DepName, Original_DepCode, Location, Telephone, Status, Original_DepName, Original_DepCode, Original_Location, Original_Telephone, Original_Status);
        }
    }
